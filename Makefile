...
## Call entrypoint
entrypoint: up
	$(DOCKER_COMPOSE_EXEC)  python ./ml_project/entry_point.py
...
## Lockdependencies with poetry
lock-dependencies: build-for-dependencies
	$(DOCKER_COMPOSE_RUN) bash -c "if [ -e /home/ramaaneesh/poetry.lock.build ]; then cp /home/ramaaneesh/poetry.lock.build ./poetry.lock; else poetry lock; fi"
